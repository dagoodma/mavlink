...
$xml_file_name = "../message_definitions/v1.0/slugs.xml";
...
<html>
<head>
	<title>MAVLINK SLUGS Message set specifications</title>
	<link rel="stylesheet" type="text/css" href="mavlink.css">
</head>
<body>
<h1>MAVLINK SLUGS Message Set</h1>

<p>
These messages define the SLUGS message set, which is the message set implemented by the ETC ground station and the SLUGS autopilot.
</p>
...
<p>
Messages are defined by the <a href="<?php echo $xml_file_name; ?>"><?php echo basename($xml_file_name); ?></a> file. The C packing/unpacking code is generated from this specification, as well as the HTML documentaiton in the section above.<br />
<br />
